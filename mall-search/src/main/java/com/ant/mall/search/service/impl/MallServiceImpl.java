package com.ant.mall.search.service.impl;
...
import com.ant.mall.search.constant.EsConstant;
import com.ant.mall.search.feign.ProductFeignService;
import com.ant.mall.search.service.MallService;
import com.ant.mall.search.vo.AttrResponseVo;
import com.ant.mall.search.vo.BrandVo;
...
public class MallServiceImpl implements MallService {
	...
	private SearchRequest buildSearchRequest(SearchParam Param) {
		...
		if(ObjectUtils.isEmpty(Param.getCatalog3Id() != null)){
